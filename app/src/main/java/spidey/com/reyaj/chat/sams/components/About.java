...
public class About extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        moveViewToScreenCenter(findViewById(R.id.names1));
        moveViewToScreenCenter(findViewById(R.id.names2));
        moveViewToScreenCenter(findViewById(R.id.names3));
        moveViewToScreenCenter(findViewById(R.id.names4));
